...
export default {
  ...
  // Button
  buttonFontFamily: fontFamily.button, // platform === PLATFORM.IOS ? 'System' : 'Roboto_medium',
  ...
  // Color
  brandPrimary: brand.primary, //platform === PLATFORM.IOS ? '#007aff' : '#3F51B5',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: fontFamily.default, // platform === PLATFORM.IOS ? 'System' : 'Roboto',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  toolbarDefaultBg: brand.primary, //platform === PLATFORM.IOS ? '#F8F8F8' : '#3F51B5',
  ...
  // Title
  titleFontfamily: fontFamily.title, // platform === PLATFORM.IOS ? 'System' : 'Roboto_medium',
